...
export const Input: React.FC<InputProps> = ({
	...
	return (
		<div className='w-full relative'>
			{formatPrice && (
				<BiDollar size={24} className=' text-neutral-700 left-2 absolute top-5'></BiDollar>
			)}
			<input
				type={type}
				id={id}
			...
			/>
			<label
				className={`peer-placeholder-shown:scale-100 absolute text-md duration-150 -translate-y-3 top-5 z-10 origin-[0] transform ${
